        ...
        <main class="flex-1 h-full overflow-y-auto bg-slate-50/50">
            ...
            <div class="max-w-7xl mx-auto px-8 py-10">
                ...
                <div class="mb-8 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 rounded shadow-sm flex items-center">
                    ...
                    <p class="font-medium">No se pudo registrar al alumno. Verifique los datos ingresados.</p>
                </div>
                <% } %>
                                        ...
                                        <c:when test="${not empty listaAlumnos}">
                                            <c:forEach var="alumno" items="${listaAlumnos}">
                                                <tr class="hover:bg-slate-50/50 transition-colors group">
                                                    ...
                                                    <td class="px-6 py-4 flex justify-end space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                        ...
                                                        <form action="${pageContext.request.contextPath}/eliminarAlumno" method="POST" 
                                                              onsubmit="return confirm('¿Confirma la eliminación permanente de este registro?');">
                                                            <input type="hidden" name="idAlumno" value="${alumno.idAlumno}">
                                                            <button type="submit" class="text-red-600 hover:text-red-900 bg-red-50 hover:bg-red-100 p-2 rounded-md transition-colors" title="Eliminar">
                                        ...
                                        <c:otherwise>
                                            <tr>
                                                <td colspan="4" class="px-6 py-12 text-center">
                                                    ...
                                                    <p class="mt-4 text-sm text-slate-500">No hay postulantes registrados actualmente.</p>
                                                </td>
                                            </tr>
                                        </c:otherwise>
                                    </c:choose>
...
</html>             <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0